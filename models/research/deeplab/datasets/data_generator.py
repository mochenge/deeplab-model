...
#---------------------------------------------------#
#   添加camvid数据集描述信息:
#   数据集camvid，算上background和ignore_label总共12个分类
#---------------------------------------------------#
_CAMVID_INFORMATION = DatasetDescriptor(
    ...
    num_classes=12,
    ignore_label=255, # 此处使用ignore_label
)

#---------------------------------------------------#
#   添加自己的数据集描述信息:
#   数据集RoadScene，算上background共有6个分类，由于没有
#   使用ignore_label，因此没有算ignore_label
#---------------------------------------------------#
_MYDATA_INFORMATION = DatasetDescriptor(
    ...
    num_classes=6,
    ignore_label=255, # 此处没有使用ignore_label，暂且保留
)

#---------------------------------------------------#
#   注册数据集:
#   camvid示例数据集，mydata为RoadScence数据集
#---------------------------------------------------#
